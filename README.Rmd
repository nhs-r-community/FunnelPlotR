...
## Funnel Plots
__This package is the newer version of the older `CMFunnels` package. Development work will focuss on this package from now on __
...
More information avaialbe at https://chrismainey.github.io/FunnelPlotR/ 
...
```
<br><br>
We can build a funnel plot object with standard Poisson limits, and outliers labelled.  The function returns a list of the plotted data, the plotted control limit range, and the ggplot object, hence `object[3]` to call it.
...
__Please read the package documentation for more info, at: https://chrismainey.github.io/FunnelPlotR/__
