...
knitr::opts_chunk$set(echo = TRUE, fig.path="docs/figures/")
```
...
[![CRAN version](http://www.r-pkg.org/badges/version/FunnelPlotR)](http://cran.r-project.org/package=FunnelPlotR)
...
```{r, funnel2, message=FALSE, fig.align='center', fig.retina=5, collapse=TRUE, warning=FALSE}
