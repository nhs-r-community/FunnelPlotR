test_that("`build limits funcion` works with input and
          returns expected data.frame", {

            z <- build_limits_lookup(10, 250, 0.65, 1.51, draw_adjusted = TRUE
                                     , tau2 = 0.02, data_type = "SR"
                                     , sr_method = "SHMI"
                                     , multiplier = 1, target = 1)
            ...
            x <- build_limits_lookup(10, 250, 0.65, 1.51, draw_adjusted = TRUE
                                     , tau2 = 0.02, data_type = "SR"
                                     , sr_method = "CQC"
                                     , multiplier = 100, target = 1)
